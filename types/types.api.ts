import { TUseApiInfiniteQueryProps, useApiInfiniteQuery, useApiMutationNew, useApiQuery } from "@hooks";
...
//
export type TMethodParams = NullUndefinedAble<RecursiveNullUndefinedPartialAble<Record<string, unknown>>>;
...
> = TGetApiMethodProp<typeof useApiQuery<TResponse, TParams, TUrlReplaceParams>>;
...
export type TUseApiIMutationMethodProp<
	...
	TParams extends TMethodParams = any,
	TUrlReplaceParams extends Record<string, unknown> = any,
> = TGetApiMethodProp<typeof useApiMutationNew<TData, TPromiseResponse, TParams, TUrlReplaceParams>>;
...
export type TMethodPassProps<T = any> = {
	...
	methodProvidedData?: NullUndefinedAble<
		{ flatData: NullUndefinedAble<T[]> } & Partial<ReturnType<TUseApiInfiniteQueryMethodProp<T>>>
	>;
...
// TODO: REMOVE
export type TApiFlatDataItemReturned<T> = RecursiveNullable<
	NonNullable<ReturnType<typeof useApiInfiniteQuery<T>>["flatDataFirstItem"]>
>;
